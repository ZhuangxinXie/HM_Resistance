...
### Imputation
Our original data `raw_data.xlsx` were collected from the previous articles. Given that there are many empty cells in this file, we used Phylo-KNN to impute the null cells.<br>
<br>
...
Therefore we develop a Phylo-KNN to capture the phylogenetic features by adding a phylogenetic distance matrix $P$.<br>
### Revision
