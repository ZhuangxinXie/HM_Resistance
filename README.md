...
<p align="center">$log BS_{Revised} = log BS_{Original} - (beta_1 × latitude + beta_2 × altitude + beta_3 × sex)$<p>
...
We assume that these distribution patterns should be symmetric along the equator
